...
class Ui_tuflowqgis_TuPlot(object):
    def setupUi(self, tuflowqgis_TuPlot):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 10, 268, 151))
        ...
        self.cbShowLegend = QtGui.QCheckBox(self.verticalLayoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cbShowLegend.setMaximumSize(QtCore.QSize(600, 40))
        self.cbShowLegend.setObjectName(_fromUtf8("cbShowLegend"))
        self.verticalLayout_4.addWidget(self.cbShowLegend)
    ...
    def retranslateUi(self, tuflowqgis_TuPlot):
        ...
        self.pbAnimateLP.setText(_translate("tuflowqgis_TuPlot", "Animate LP", None))
        self.label5.setText(_translate("tuflowqgis_TuPlot", "Selected Elements (display only)", None))
        self.label6.setText(_translate("tuflowqgis_TuPlot", "Time (Long Profile Only)", None))
        ...
        self.cbShowLegend.setText(_translate("tuflowqgis_TuPlot", "Show Legend", None))
