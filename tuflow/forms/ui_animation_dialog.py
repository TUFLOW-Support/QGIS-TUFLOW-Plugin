...
# Form implementation generated from reading ui file 'C:\Users\esymons\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\tuflow\forms\ui_animation_dialog.ui'
#
...
from ..compatibility_routines import QT_FORM_LAYOUT_FIELD_ROLE, QT_BUTTON_BOX_CANCEL, QT_SIZE_POLICY_EXPANDING, QT_FORM_LAYOUT_SPANNING_ROLE, QT_SIZE_POLICY_FIXED, QT_ABSTRACT_ITEM_VIEW_ALL_EDIT_TRIGGERS, QT_FRAME_NO_FRAME, QT_SIZE_POLICY_MINIMUM, QT_BUTTON_BOX_OK, QT_FORM_LAYOUT_LABEL_ROLE, QT_HORIZONTAL
...
class Ui_AnimationDialog(object):
    def setupUi(self, AnimationDialog):
        ...
        self.formLayout.setWidget(2, QT_FORM_LAYOUT_LABEL_ROLE, self.label_6)
        self.cboStart = QtWidgets.QComboBox(self.tab)
        self.cboStart.setObjectName("cboStart")
        self.formLayout.setWidget(2, QT_FORM_LAYOUT_FIELD_ROLE, self.cboStart)
        self.label_7 = QtWidgets.QLabel(self.tab)
        self.label_7.setObjectName("label_7")
        self.formLayout.setWidget(3, QT_FORM_LAYOUT_LABEL_ROLE, self.label_7)
        self.cboEnd = QtWidgets.QComboBox(self.tab)
        self.cboEnd.setObjectName("cboEnd")
        self.formLayout.setWidget(3, QT_FORM_LAYOUT_FIELD_ROLE, self.cboEnd)
        self.label_13 = QtWidgets.QLabel(self.tab)
        self.label_13.setObjectName("label_13")
        self.formLayout.setWidget(4, QT_FORM_LAYOUT_LABEL_ROLE, self.label_13)
        self.cboResult = QtWidgets.QComboBox(self.tab)
        self.cboResult.setObjectName("cboResult")
        self.formLayout.setWidget(4, QT_FORM_LAYOUT_FIELD_ROLE, self.cboResult)
        self.label_11 = QtWidgets.QLabel(self.tab)
        self.label_11.setObjectName("label_11")
        self.formLayout.setWidget(5, QT_FORM_LAYOUT_LABEL_ROLE, self.label_11)
        self.cboScalar = QtWidgets.QComboBox(self.tab)
        self.cboScalar.setObjectName("cboScalar")
        self.formLayout.setWidget(5, QT_FORM_LAYOUT_FIELD_ROLE, self.cboScalar)
        self.label_12 = QtWidgets.QLabel(self.tab)
        self.label_12.setObjectName("label_12")
        self.formLayout.setWidget(6, QT_FORM_LAYOUT_LABEL_ROLE, self.label_12)
        self.cboVector = QtWidgets.QComboBox(self.tab)
        self.cboVector.setObjectName("cboVector")
        self.formLayout.setWidget(6, QT_FORM_LAYOUT_FIELD_ROLE, self.cboVector)
        self.label_2 = QtWidgets.QLabel(self.tab)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(7, QT_FORM_LAYOUT_LABEL_ROLE, self.label_2)
        ...
        self.formLayout.setWidget(7, QT_FORM_LAYOUT_FIELD_ROLE, self.spinWidth)
        self.label_3 = QtWidgets.QLabel(self.tab)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(8, QT_FORM_LAYOUT_LABEL_ROLE, self.label_3)
        ...
        self.formLayout.setWidget(8, QT_FORM_LAYOUT_FIELD_ROLE, self.spinHeight)
        self.label = QtWidgets.QLabel(self.tab)
        self.label.setObjectName("label")
        self.formLayout.setWidget(9, QT_FORM_LAYOUT_LABEL_ROLE, self.label)
        ...
        self.formLayout.setLayout(9, QT_FORM_LAYOUT_FIELD_ROLE, self.horizontalLayout)
        self.label_8 = QtWidgets.QLabel(self.tab)
        self.label_8.setObjectName("label_8")
        self.formLayout.setWidget(11, QT_FORM_LAYOUT_LABEL_ROLE, self.label_8)
        self.spinSpeed = QtWidgets.QSpinBox(self.tab)
        self.spinSpeed.setMinimum(1)
        self.spinSpeed.setMaximum(60)
        self.spinSpeed.setProperty("value", 30)
        self.spinSpeed.setObjectName("spinSpeed")
        self.formLayout.setWidget(11, QT_FORM_LAYOUT_FIELD_ROLE, self.spinSpeed)
        self.label_25 = QtWidgets.QLabel(self.tab)
        self.label_25.setObjectName("label_25")
        self.formLayout.setWidget(12, QT_FORM_LAYOUT_LABEL_ROLE, self.label_25)
        self.sbTargetDur = QtWidgets.QSpinBox(self.tab)
        self.sbTargetDur.setMinimum(1)
        self.sbTargetDur.setMaximum(999)
        self.sbTargetDur.setProperty("value", 15)
        self.sbTargetDur.setObjectName("sbTargetDur")
        self.formLayout.setWidget(12, QT_FORM_LAYOUT_FIELD_ROLE, self.sbTargetDur)
        self.cbMethod1 = QtWidgets.QCheckBox(self.tab)
        self.cbMethod1.setObjectName("cbMethod1")
        self.formLayout.setWidget(10, QT_FORM_LAYOUT_SPANNING_ROLE, self.cbMethod1)
        ...
        spacerItem = QtWidgets.QSpacerItem(28, 20, QT_SIZE_POLICY_FIXED, QT_SIZE_POLICY_MINIMUM)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 488, 1151))
        ...
        self.gridLayout_6.addWidget(self.cbTimeBackground, 3, 0, 1, 3)
        ...
        self.cboPosTime.addItem("")
        self.cboPosTime.addItem("")
        self.gridLayout_6.addWidget(self.cboPosTime, 5, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.fbtnTime, 2, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.colorTimeBackground, 3, 3, 1, 1)
        self.labelTime = QtWidgets.QLineEdit(self.groupTime)
        self.labelTime.setObjectName("labelTime")
        self.gridLayout_6.addWidget(self.labelTime, 1, 1, 1, 3)
        ...
        self.gridLayout_6.addWidget(self.colorTimeFrame, 4, 3, 1, 1)
        self.cbTimeFrame = QtWidgets.QCheckBox(self.groupTime)
        self.cbTimeFrame.setObjectName("cbTimeFrame")
        self.gridLayout_6.addWidget(self.cbTimeFrame, 4, 0, 1, 3)
        ...
        self.gridLayout_6.addWidget(self.colorTimeText, 2, 3, 1, 1)
        self.label_26 = QtWidgets.QLabel(self.groupTime)
        self.label_26.setObjectName("label_26")
        self.gridLayout_6.addWidget(self.label_26, 0, 0, 1, 1)
        self.le_time_format = QtWidgets.QLineEdit(self.groupTime)
        self.le_time_format.setObjectName("le_time_format")
        self.gridLayout_6.addWidget(self.le_time_format, 0, 1, 1, 1)
        self.label_27 = QtWidgets.QLabel(self.groupTime)
        self.label_27.setOpenExternalLinks(True)
        self.label_27.setObjectName("label_27")
        self.gridLayout_6.addWidget(self.label_27, 0, 2, 1, 2)
        ...
        self.tablePlots.setEditTriggers(QT_ABSTRACT_ITEM_VIEW_ALL_EDIT_TRIGGERS)
        ...
        self.tablePlots.verticalHeader().setDefaultSectionSize(21)
        ...
        self.tableGraphics.setEditTriggers(QT_ABSTRACT_ITEM_VIEW_ALL_EDIT_TRIGGERS)
        ...
        self.tableImages.setEditTriggers(QT_ABSTRACT_ITEM_VIEW_ALL_EDIT_TRIGGERS)
        ...
        self.tableImages.verticalHeader().setDefaultSectionSize(21)
        ...
        spacerItem6 = QtWidgets.QSpacerItem(28, 20, QT_SIZE_POLICY_FIXED, QT_SIZE_POLICY_MINIMUM)
        ...
        self.formLayout_2.setWidget(0, QT_FORM_LAYOUT_LABEL_ROLE, self.label_4)
        ...
        self.formLayout_2.setWidget(0, QT_FORM_LAYOUT_FIELD_ROLE, self.radQualBest)
        ...
        self.formLayout_2.setWidget(1, QT_FORM_LAYOUT_FIELD_ROLE, self.radQualHigh)
        self.radQualLow = QtWidgets.QRadioButton(self.tab_3)
        self.radQualLow.setObjectName("radQualLow")
        self.formLayout_2.setWidget(2, QT_FORM_LAYOUT_FIELD_ROLE, self.radQualLow)
        ...
        self.formLayout_2.setWidget(5, QT_FORM_LAYOUT_SPANNING_ROLE, self.groupBox)
        spacerItem7 = QtWidgets.QSpacerItem(20, 500, QT_SIZE_POLICY_MINIMUM, QT_SIZE_POLICY_EXPANDING)
        self.formLayout_2.setItem(3, QT_FORM_LAYOUT_FIELD_ROLE, spacerItem7)
        self.label_24 = QtWidgets.QLabel(self.tab_3)
        self.label_24.setWordWrap(True)
        self.label_24.setObjectName("label_24")
        self.formLayout_2.setWidget(4, QT_FORM_LAYOUT_SPANNING_ROLE, self.label_24)
    ...
    def retranslateUi(self, AnimationDialog):
        ...
        self.label_25.setText(_translate("AnimationDialog", "Target Duration"))
        self.sbTargetDur.setSuffix(_translate("AnimationDialog", " sec"))
        self.cbMethod1.setText(_translate("AnimationDialog", "Revert to old method (doesn\'t use target duration)"))
        ...
        self.label_26.setText(_translate("AnimationDialog", "Format"))
        self.label_27.setText(_translate("AnimationDialog", "<html><head/><body><p>(<a href=\"https://docs.python.org/3/library/datetime.html#strftime-and-strptime-format-codes\"><span style=\" text-decoration: underline; color:#0000ff;\">format guide</span></a>: e.g. default %H:%M:%S.%f)</p></body></html>"))
        ...
        self.radQualBest.setText(_translate("AnimationDialog", "Best (lossless)  **Note playback limitations below"))
        ...
        self.label_24.setText(_translate("AnimationDialog", "<html><head/><body><p>**Best (lossless) option requires certain codecs for playback that may not necessarily be included by default by video players such as Windows Media Player. Programs such as VLC player (among others) do tend to include these by default and are able to play resulting animation. </p><p>Note for the above reason programs such as Powerpoint may not be able to play Best (lossless) option if included as embedded media.</p></body></html>"))
