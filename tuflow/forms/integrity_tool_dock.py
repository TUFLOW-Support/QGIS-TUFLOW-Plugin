...
class Ui_IntegrityTool(object):
    def setupUi(self, IntegrityTool):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -104, 583, 783))
    ...
    def retranslateUi(self, IntegrityTool):
        ...
        self.label_12.setText(_translate("IntegrityTool", "<html><head/><body><p><span style=\" font-weight:600;\">Check entire netowrk for downstream pipe continuity.</span></p><p>Documentation:<br/><a href=\"https://wiki.tuflow.com/index.php?title=1D_Integrity_Tool_-_Continuity\"><span style=\" text-decoration: underline; color:#0000ff;\">https://wiki.tuflow.com/index.php?title=1D_Integrity_Tool_-_Continuity<br/></span></a></p></body></html>"))
