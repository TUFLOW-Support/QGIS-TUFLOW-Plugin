...
class TuPlot():
	...
	def setAxisNames(self, plotNo, types, plotAsCollection=(), plotAsQuiver=(), return_unit_only=False, unit_system=None, context=None):
		...
		units = OrderedDict({
			...
			r'\(xs\).*': ('m RL', 'ft RL', ''),
			r'\(nwk\).*': ('m RL', 'ft RL', ''),
            r'TURBZ_TKE': ('m$^2$/s$^2$', 'ft$^2$/s$^2$', ''),
            r'TURBZ_EPS': ('m$^2$/s$^3$', 'ft$^2$/s$^3$', ''),
            r'TURBZ_L': ('m', 'ft', ''),
            r'TURBZ_SPFSQ': ('1/s$^2$', '1/s$^2$', ''),
            r'TURBZ_BVFSQ': ('1/s$^2$', '1/s$^2$', ''),
            r'TURBZ_NUM': ('m$^2$/s', 'ft$^2$/s', ''),
            r'TURBZ_NUH': ('m$^2$/s', 'ft$^2$/s', ''),
            r'TURBZ_NUS': ('m$^2$/s', 'ft$^2$/s', ''),
            r'Bed load.*': ('g m$^{-1}$ s$^{-1}$', 'g m$^{-1}$ s$^{-1}$', ''),
            r'Suspended load.*': ('g m$^{-1}$ s$^{-1}$', 'g m$^{-1}$ s$^{-1}$', ''),
            r'Sediment load.*': ('g m$^{-1}$ s$^{-1}$', 'g m$^{-1}$ s$^{-1}$', ''),
            r'Photo.*faces': ('W/m$^2$', 'W/m$^2$', ''),
            r'Photo.*centres': ('W/m$^2$', 'W/m$^2$', ''),
            r'wave near-bed.*period': ('s', 's', ''),
            r'Wave near-bed.*amplitude': ('s', 's', ''),
            r'VX': ('m/s', 'ft/s', ''),
            r'VY': ('m/s', 'ft/s', ''),
		})
		...
		shortNames = OrderedDict({
			...
			r'\(xs\).*': 'Elevation',
			r'\(nwk\).*': 'Elevation',
            r'TURBZ_TKE': 'turbz_tke',
            r'TURBZ_EPS': 'turbz_eps',
            r'TURBZ_L': 'turbz_l',
            r'TURBZ_SPFSQ': 'turbz_spfsq',
            r'TURBZ_BVFSQ': 'turbz_bvfsq',
            r'TURBZ_NUM': 'turbz_num',
            r'TURBZ_NUH': 'turbz_nuh',
            r'TURBZ_NUS': 'turbz_nus',
            r'Bed load.*':'Bed load SED',
            r'Suspended load.*':'Susp load SED',
            r'Sediment load.*':'Sediment load SED',
            r'Photo.*faces': 'PAR',
            r'Photo.*centres': 'PAR_CC',
            r'wave near-bed.*period': 'WVPERBOT',
            r'Wave near-bed.*amplitude': 'WVUBOT',
            r'VX': 'VX',
            r'VY': 'VY',
		})
