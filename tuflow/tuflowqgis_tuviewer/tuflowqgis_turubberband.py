...
class TuRubberBand():
	...
	def __init__(self, TuPlot, plotNo):
		...
		self.plotNo = plotNo
		self.firstTimePlotting = ["timeSeriesPlotFirst", "profilePlotFirst"]
		self.holdPlot = ["holdTimeSeriesPlot", "holdLongProfilePlot"]
		self.clearedPlot = ["clearedTimeSeriesPlot", "clearedLongPlot"]
		self.allowLiveTracking = False
