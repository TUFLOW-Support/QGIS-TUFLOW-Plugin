...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="Type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="1" value="Chan [C]" label="Chan [C]"/>
      <category render="true" symbol="2" value="Chan [R]" label="Chan [R]"/>
      <category render="true" symbol="3" value="Chan [S]" label="Chan [S]"/>
      <category render="true" symbol="4" value="Chan [W]" label="Chan [W]"/>
      <category render="true" symbol="5" value="Chan [X]" label="Chan[X]"/>
      <category render="true" symbol="6" value="Chan [B]" label="Chan [B]"/>
      <category render="true" symbol="7" value="Chan [Q]" label="Chan [Q]"/>
      <category render="true" symbol="8" value="2D" label="2D PO"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="8">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,54,32,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <aliases>
    ...
    <alias field="Source" index="2" name=""/>
  </aliases>
