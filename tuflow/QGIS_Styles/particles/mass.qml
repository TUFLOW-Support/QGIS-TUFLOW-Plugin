...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" simplifyDrawingHints="0" version="3.13.0-Master" simplifyAlgorithm="0" minScale="100000000" maxScale="0">
  ...
  <renderer-v2 forceraster="0" graduatedMethod="GraduatedColor" type="graduatedSymbol" attr="age" enableorderby="0" symbollevels="0">
    <ranges>
      <range label="0 - 0.5" symbol="0" upper="0.500000000000000" lower="0.000000000000000" render="true"/>
      <range label="0.5 - 1" symbol="1" upper="1.000000000000000" lower="0.500000000000000" render="true"/>
      <range label="1 - 2" symbol="2" upper="2.000000000000000" lower="1.000000000000000" render="true"/>
      <range label="2 - 3" symbol="3" upper="3.000000000000000" lower="2.000000000000000" render="true"/>
      <range label="3 - 5" symbol="4" upper="5.000000000000000" lower="3.000000000000000" render="true"/>
    </ranges>
    <symbols>
      <symbol type="marker" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="231,248,213,255"/>
      ...
      <symbol type="marker" name="1" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="172,245,168,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
    ...
    <colorramp type="cpt-city" name="[source]">
      ...
      <prop k="schemeName" v="gmt/GMT_ocean"/>
