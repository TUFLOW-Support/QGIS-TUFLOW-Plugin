...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" simplifyDrawingHints="0" version="3.13.0-Master" simplifyAlgorithm="0" minScale="100000000" maxScale="0">
  ...
  <renderer-v2 forceraster="0" graduatedMethod="GraduatedColor" type="graduatedSymbol" attr="age" enableorderby="0" symbollevels="0">
    <ranges>
      <range label="0 - 1 hrs" symbol="0" upper="1.000000000000000" lower="0.000000000000000" render="true"/>
      <range label="1 - 2  hrs" symbol="1" upper="2.000000000000000" lower="1.000000000000000" render="true"/>
      <range label="2 - 3  hrs" symbol="2" upper="3.000000000000000" lower="2.000000000000000" render="true"/>
      <range label="3 - 5  hrs" symbol="3" upper="5.000000000000000" lower="3.000000000000000" render="true"/>
      <range label="5 - 100  hrs" symbol="4" upper="100.000000000000000" lower="5.000000000000000" render="true"/>
    </ranges>
    <symbols>
      <symbol type="marker" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="0,63,92,255"/>
    ...
    <source-symbol>
      <symbol type="marker" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="157,222,225,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
    ...
    <colorramp type="gradient" name="[source]">
      <prop k="color1" v="44,123,182,255"/>
      <prop k="color2" v="215,25,28,255"/>
      <prop k="discrete" v="0"/>
      <prop k="rampType" v="gradient"/>
      <prop k="stops" v="0.25;171,217,233,255:0.5;255,255,191,255:0.75;253,174,97,255"/>
    </colorramp>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;age&quot;" sortOrder="1">
    <columns>
