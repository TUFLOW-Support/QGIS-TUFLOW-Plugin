...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" simplifyDrawingHints="0" version="3.13.0-Master" simplifyAlgorithm="0" minScale="100000000" maxScale="0">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" attr="groupID" enableorderby="0" symbollevels="0">
    <categories>
      <category value="1" label="Group Name 1" symbol="0" render="true"/>
      <category value="2" label="Group Name 2 " symbol="1" render="true"/>
      <category value="3" label="Group Name 3" symbol="2" render="true"/>
      <category value="4" label="Group Name 4" symbol="3" render="true"/>
      <category value="5" label="Group Name 5" symbol="4" render="true"/>
      <category value="" label="Other" symbol="5" render="true"/>
    </categories>
    <symbols>
      <symbol type="marker" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="195,28,224,255"/>
