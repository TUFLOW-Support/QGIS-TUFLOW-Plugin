...
class Ui_PlotProperties(object):
    ...
    def retranslateUi(self, PlotProperties):
        ...
        self.cboLegendPos.setItemText(0, _translate("PlotProperties", "Auto"))
        self.cboLegendPos.setItemText(1, _translate("PlotProperties", "Top-Left"))
        self.cboLegendPos.setItemText(2, _translate("PlotProperties", "Top-Right"))
        self.cboLegendPos.setItemText(3, _translate("PlotProperties", "Bottom-Left"))
        self.cboLegendPos.setItemText(4, _translate("PlotProperties", "Bottom-Right"))
