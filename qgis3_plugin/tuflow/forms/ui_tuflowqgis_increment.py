...
#        self.buttonBox = QtGui.QDialogButtonBox(tuflowqgis_increment)
        ...
        self.checkBox = QCheckBox(tuflowqgis_increment)
        ...
        self.buttonBox.accepted.connect(tuflowqgis_increment.accept)
        #QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), tuflowqgis_increment.reject)
        self.buttonBox.rejected.connect(tuflowqgis_increment.reject)
