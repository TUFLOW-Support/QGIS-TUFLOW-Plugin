...
class Ui_AnimationDialog(object):
    def setupUi(self, AnimationDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -417, 488, 869))
        ...
        self.cboPosTitle.addItem("")
        self.cboPosTitle.addItem("")
        self.gridLayout_5.addWidget(self.cboPosTitle, 3, 1, 1, 2)
        ...
        self.cboPosTime.addItem("")
        self.cboPosTime.addItem("")
        self.gridLayout_6.addWidget(self.cboPosTime, 3, 1, 1, 1)
        ...
        self.cboPosLegend.addItem("")
        self.cboPosLegend.addItem("")
        self.gridLayout_7.addWidget(self.cboPosLegend, 3, 1, 1, 1)
        ...
        self.tableImages.setColumnCount(4)
    ...
    def retranslateUi(self, AnimationDialog):
        ...
        item.setText(_translate("AnimationDialog", "Size X (mm)"))
        item = self.tableImages.horizontalHeaderItem(3)
        item.setText(_translate("AnimationDialog", "Size Y (mm)"))
